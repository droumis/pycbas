...
| Dataset | Mode | Subjects | Sequences | pycbas | Igor reference | k |
|---|---|---|---|---|---|---|
...
- 1,605/2,046 significant (k=81) — **exact match** with the Igor reference
...
- 31/408 significant (k=2) — **exact match** with the Igor reference
...
- 572/16,378 significant (k=29) — **exact match** with the Igor reference
- 105 subjects (55 control, 50 lesion), all_published cohort (genotype==0, lesion known)
- Test statistics match the Igor reference within 1e-6 on all 16,376 overlapping sequences
- All 572 significant sequences identical between pycbas and Igor
- Runtime: ~12s | Peak RAM: ~3.6 GB

[Full report](rats/validation_report.md)

## Algorithm notes

Three key fixes brought us into exact alignment with the Igor reference implementation:
